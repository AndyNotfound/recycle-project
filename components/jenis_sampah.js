...
const jenis_sampah = () => {
    return (
        <>
            <div className="bg-cyan-100 w-screen md:p-6">
                <section className="my-32">
                    <h2 className="mb-8 text-5xl font-bold leading-tight tracking-tight text-center">
                        JENIS SAMPAH
                    </h2>
                            ...
                            <div className="flex flex-wrap">
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">1</p>
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">2</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">3</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">4</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                                Vestibulum gravida iaculis nisl, vel lobortis eros. Praesent
                                                vulputate lacus bibendum augue.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">5</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                                Pellentesque mollis, metus nec fringilla aliquam. Donec
                                                consequat orci quis volutpat imperdiet.
                                            </p>
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">6</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                                Magna lacus iaculis elit, quis pharetra varius. Aenean
                                                lectus ex, placerat id tellus in eros.
                                            </p>
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">7</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                                Pellentesque varius ex vel consequat quis. Sed mauris ex,
                                                imperdiet sit amet nisl ac, ultrices.
                                            </p>
                                ...
                                <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                    <div className="flex">
                                        ...
                                        <div className="ml-4 grow">
                                            <p className="mb-3 font-bold">8</p>
                                            <p className="text-neutral-500 dark:text-neutral-300">
                                                Vestibulum gravida iaculis nisl, vel lobortis eros. Praesent
                                                vulputate lacus bibendum augue.
                                            </p>
