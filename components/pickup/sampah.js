                    ...
                    <div className="flex flex-wrap justify-center">
                        <div className="mb-md-0 mb-6 w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
                            <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
                                <div className="mb-12 lg:mb-0 w-full shrink-0 grow-0 basis-auto lg:w-6/12 lg:px-3">
                                                ...
                                                <div className="ml-4 grow">
                                                    <div className="shrink-0">
                                                        <div className="inline-block rounded-md bg-primary-100 p-4 text-primary">
                                                            ...
                                                            <h5 className="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">Kertas</h5>
                                                            <button
                                                            type="button"
